...
<simconf>
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype860933190</identifier>
...
make -j$(CPUS) TARGET=cooja node.cooja</commands>
    ...
    <mote>
      ...
      <motetype_identifier>mtype860933190</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.3999999999999995 0.0 0.0 2.3999999999999995 32.000000000000014 8.000000000000004</viewport>
    </plugin_config>
    <width>236</width>
    <z>1</z>
    <height>230</height>
